...
public class DashGirdAdapter extends ArrayAdapter<ItemMhs> {
    public DashGirdAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<ItemMhs> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (null == convertView){
            ...
            convertView = inflater.inflate(R.layout.dash_gird_item, null);
        }
